/***************************************************************************//**
 * @file    markley.h
 * @brief   Markley method
 * @details direct solver with quintic convergence; after description in:
 * Markley (1995), Celestial Mechanics & Dynamical Astronomy 63, p.101-111
 * @author  Bazso Akos
 *
 * @copyright
 ...
 ******************************************************************************/
#pragma once
#ifndef KES_SOL_MARKLEY__H
#define KES_SOL_MARKLEY__H
...
/*!
 * @brief iteration function for Markley method of order 5
