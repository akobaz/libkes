/***************************************************************************//**
 * @file    mikkola.h
 * @brief   Mikkola method
 * @details quintic convergence; after description in:
 * Mikkola (1987), Celestial Mechanics 40, p. 329-334
 * @author  Bazso Akos
 *
 * @copyright
 ...
 ******************************************************************************/
#pragma once
#ifndef KES_SOL_MIKKOLA__H
#define KES_SOL_MIKKOLA__H
...
/*!
 * @brief iteration function for Mikkola method of order 5
